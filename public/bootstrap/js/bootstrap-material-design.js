...
const Button = function ($$$1) {
  ...
  function () {
    ...
    Button._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        const data = $$$1(this).data(DATA_KEY);
  ...
  function () {
    ...
    Carousel._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        ...
        const _config = _extends({}, Default, $$$1(this).data());
...
const Collapse = function ($$$1) {
  ...
  function () {
    function Collapse(element, config) {
      ...
      for (const i = 0; i < tabToggles.length; i++) {
    ...
    _proto.hide = function hide() {
      ...
      if (this._triggerArray.length > 0) {
        for (const i = 0; i < this._triggerArray.length; i++) {
  ...
  function () {
    ...
    _proto.toggle = function toggle(event) {
      ...
      if (event) {
        ...
        const context = $$$1(event.currentTarget).data(dataKey);
...
const ScrollSpy = function ($$$1) {
  ...
  function () {
    ...
    _proto._getConfig = function _getConfig(config) {
      ...
      if (typeof config.target !== 'string') {
        const id = $$$1(config.target).attr('id');
    ...
    _proto._process = function _process() {
      ...
      for (const i = this._offsets.length; i--;) {
    ...
    _proto._activate = function _activate(target) {
      ...
      const queries = this._selector.split(','); // eslint-disable-next-line arrow-body-style
  ...
  $$$1(window).on(Event.LOAD_DATA_API, function () {
    ...
    for (const i = scrollSpys.length; i--;) {
...
const Util$2 = function () {
  /**
   * ------------------------------------------------------------------------
   * Private TransitionEnd Helpers
   * ------------------------------------------------------------------------
   */
  const transitionEnd = false;
  const _transitionEndSelector = "";
  ...
  function transitionEndTest() {
    ...
    const el = document.createElement("bmd");
...
const Base = function ($$$1) {
  ...
  function () {
    ...
    _proto.findMdbFormGroup = function findMdbFormGroup(raiseError) {
      ...
      const mfg = this.$element.closest(Selector.BMD_FORM_GROUP);
...
const BaseInput = function ($$$1) {
  ...
  const Selector = {
    ...
    BMD_FORM_GROUP: "." + ClassName.BMD_FORM_GROUP,
    BMD_LABEL_WILDCARD: "label[class^='" + ClassName.BMD_LABEL + "'], label[class*=' " + ClassName.BMD_LABEL + "']" // match any label constiant if specified
  ...
  const Default = {
    ...
    convertInputSizeconstiations: true
  };
  ...
  function (_Base) {
    ...
    function BaseInput($element, config, properties) {
      ...
      _this.$bmdLabel = _this.resolveMdbLabel(); // Signal to the bmd-form-group that a form-control-* constiation is being used
    ...
    const _proto = BaseInput.prototype;
    ...
    _proto.addChangeListener = function addChangeListener() {
      ...
      this.$element.on("keydown paste", function (event) {
        ...
        if (_this3.config.validate) {
          ...
          const isValid = typeof _this3.$element[0].checkValidity === "undefined" || _this3.$element[0].checkValidity();
    ...
    _proto.resolveMdbFormGroup = function resolveMdbFormGroup() {
      const mfg = this.findMdbFormGroup(false);
    ...
    _proto.resolveMdbLabel = function resolveMdbLabel() {
      const label = this.$bmdFormGroup.find(Selector.BMD_LABEL_WILDCARD);
      ...
      return label;
    }; // Find bmd-label constiant based on the config selectors
    ...
    _proto.findMdbLabel = function findMdbLabel(raiseError) {
      ...
      const label = null; // use the specified selector order

      for (const _iterator = this.config.label.selectors, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        const _ref;
    ...
    _proto.findFormGroup = function findFormGroup(raiseError) {
      ...
      const fg = this.$element.closest(Selector.FORM_GROUP);
      ...
      return fg;
    }; // Due to the interconnected nature of labels/inputs/help-blocks, signal the bmd-form-group-* size constiation based on
    //  a found form-control-* size


    _proto.resolveMdbFormGroupSizing = function resolveMdbFormGroupSizing() {
      if (!this.config.convertInputSizeconstiations) {
        return;
      } // Modification - Change text-sm/lg to form-group-sm/lg instead (preferred standard and simpler css/less constiants)


      for (const inputSize in FormControlSizeMarkers) {
    ...
    _proto._rejectInvalidComponentMatches = function _rejectInvalidComponentMatches() {
      for (const _iterator2 = this.config.invalidComponentMatches, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
        const _ref2;
    ...
    _proto._rejectWithoutRequiredClasses = function _rejectWithoutRequiredClasses() {
      for (const _iterator3 = this.config.requiredClasses, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
        const _ref3;
        ...
        const _requiredClass = _ref3;
        if (_requiredClass.indexOf("||") !== -1) {
          const oneOf = _requiredClass.split("||");

          for (const _iterator4 = oneOf, _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
            const _ref4;
...
const BaseSelection = function ($$$1) {
  /**
   * ------------------------------------------------------------------------
   * Constants
   * ------------------------------------------------------------------------
  ...
  function (_BaseInput) {
    ...
    const _proto = BaseSelection.prototype;

    _proto.decorateMarkup = function decorateMarkup() {
      const $decorator = $$$1(this.config.template);
...
const Checkbox = function ($$$1) {
  ...
  const JQUERY_NO_CONFLICT = $$$1.fn[JQUERY_NAME];
  const Default = {
  ...
  function (_BaseSelection) {
    ...
    const _proto = Checkbox.prototype;
...
const CheckboxInline = function ($$$1) {
  /**
   * ------------------------------------------------------------------------
   * Constants
   * ------------------------------------------------------------------------
  ...
  function (_Checkbox) {
    ...
    const _proto = CheckboxInline.prototype;
...
const CollapseInline = function ($$$1) {
  /**
   * ------------------------------------------------------------------------
   * Constants
   * ------------------------------------------------------------------------
  ...
  function (_Base) {
    ...
    function CollapseInline($element, config) {
      ...
      const collapseSelector = $element.data("target");
      ...
      const $inputs = _this.$bmdFormGroup.find(Selector.ANY_INPUT);
    ...
    const _proto = CollapseInline.prototype;
...
const RadioInline = function ($$$1) {
  ...
  function (_Radio) {
    ...
    const _proto = RadioInline.prototype;
...
const BaseFormControl = function ($$$1) {
  /**
   * ------------------------------------------------------------------------
   * Constants
   * ------------------------------------------------------------------------
...
const Textarea = function ($$$1) {
  ...
  function (_BaseFormControl) {
    ...
    const _proto = Textarea.prototype;
...
const Dropdown = function ($$$1) {
  ...
  function () {
    ...
    _proto.toggle = function toggle() {
      ...
      const element = this._element; // for dropup with alignment we use the parent as popper container
    ...
    _proto._getConfig = function _getConfig(config) {
      const elementData = $$$1(this._element).data();
    ...
    _proto._getPlacement = function _getPlacement() {
      ...
      const placement = this._config.placement; // Handle dropup
    ...
    Dropdown._clearMenus = function _clearMenus(event) {
      ...
      for (const i = 0; i < toggles.length; i++) {
        const _ret = _loop(i);
...
const BaseLayout = function ($$$1) {
  ...
  function (_Base) {
    ...
    const _proto = BaseLayout.prototype;
    ...
    _proto.resolveCanvas = function resolveCanvas() {
      const bd = this.findCanvas(false);
    ...
    _proto.findCanvas = function findCanvas(raiseError, context) {
      ...
      const canvas = context.closest(Selector.CANVAS);
    ...
    _proto.resolveBackdrop = function resolveBackdrop() {
      const bd = this.findBackdrop(false);
    ...
    _proto.findBackdrop = function findBackdrop(raiseError, context) {
      ...
      const backdrop = context.find("> " + Selector.BACKDROP);
    ...
    _proto.findContainer = function findContainer(raiseError, context) {
      ...
      const container = context.closest(Selector.CONTAINER);
...
const Drawer = function ($$$1) {
  ...
  function (_BaseLayout) {
    ...
    _proto.show = function show() {
      ...
      const $focusOn = this.$element.find(this.config.focusSelector);
...
const Ripples = function ($$$1) {
  ...
  function () {
    ...
    const _proto = Ripples.prototype;
    ...
    _proto._onStartRipple = function _onStartRipple(event) {
      ...
      const relY = this._getRelY(event);

      const relX = this._getRelX(event); // If relY and/or relX are false, return the event
    ...
    _proto._getRelX = function _getRelX(event) {
      const wrapperOffset = this.$container.offset();
      const result = null;
    ...
    _proto._getRipplesColor = function _getRipplesColor() {
      const color = this.$element.data("ripple-color") ? this.$element.data("ripple-color") : window.getComputedStyle(this.$element[0]).color;
      return color;
    };
    /**
...
const Autofill = function ($$$1) {
  ...
  function (_Base) {
    ...
    const _proto = Autofill.prototype;
    ...
    _proto._attachEventHandlers = function _attachEventHandlers() {
      ...
      $$$1(document).on("focus", "input", function (event) {
        const $inputs = $$$1(event.currentTarget).closest("form").find("input").not("[type=file]");
...
const BootstrapMaterialDesign = function ($$$1) {
  /**
   * ------------------------------------------------------------------------
   * Constants
   * ------------------------------------------------------------------------
  ...
  function () {
    function BootstrapMaterialDesign($element, config) {
      ...
      const _loop = function _loop(component) {
        // the component's config fragment is passed in directly, allowing users to override
        const componentConfig = _this.config[component]; // check to make sure component config is enabled (not `false`)

        if (componentConfig) {
          // assemble the selector as it may be an array
          const selector = _this._resolveSelector(componentConfig); // mix in global options
          ...
          const jqueryFn = "bmd" + componentName;
          ...
          try {
            ...
            const message = "Failed to instantiate component: $('" + selector + "')[" + jqueryFn + "](" + componentConfig + ")";
      ...
      for (const _iterator = this.config.instantiation, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        const _ref;
    ...
    const _proto = BootstrapMaterialDesign.prototype;
    ...
    _proto._resolveSelector = function _resolveSelector(componentConfig) {
      const selector = componentConfig.selector;
